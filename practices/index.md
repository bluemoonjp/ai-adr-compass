...
| 0002 | Every ADR declares exactly one Status value from a closed set, plus the date it was decided; an undated or unstated record forces a reader to re-derive context. | adr-format | general | 2026-09-22 |
