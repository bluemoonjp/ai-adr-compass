---
id: "0004"
title: Measure the corpus, not just each new record
status: active
topic: adr-volume
applies_to: [general]
...
license: CC-BY-4.0
sources:
  - url: https://raw.githubusercontent.com/bluemoonjp/ai-adr-compass/main/measurements/2026-09-22-corpus-a.md
    kind: primary
    confidence: derived
    verified_on: "2026-09-22"
    summary: This repository's own docs/adr/, measured directly with starter/adr-volume-guard/ — record count, fan-in/fan-out (total and distinct), generation rate, and staleness, computed from the corpus's own record text.
---
