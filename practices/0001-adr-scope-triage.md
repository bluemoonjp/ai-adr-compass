---
id: "0001"
title: Triage before capturing a decision as an ADR
status: active
topic: adr-scope
applies_to: [general]
...
license: CC-BY-4.0
sources:
  - url: https://www.infoq.com/articles/architectural-decision-record-purpose/
    kind: primary
    confidence: verified
    verified_on: "2026-09-22"
    summary: Pureur and Bittner argue an ADR log loses its purpose once every decision a team makes is logged in it, and give a cost-of-change-based test for which decisions are actually architectural.
    quote: All architectural decisions are significant (using the cost of change to measure significance) but not all significant decisions are architectural.
  - url: https://ozimmer.ch/practices/2021/04/23/AnyDecisionRecords.html
    kind: primary
    confidence: verified
    verified_on: "2026-09-22"
    summary: Zimmermann, a maintainer of MADR, warns that filling a template out of habit gains little and states that not all decisions are worth capturing, so a triage step is required.
    quote: "Not all decisions are worth capturing; triages are required. Checklists and criteria can help with that and with ending the making of a decision (to move on to the next issue)."
---
